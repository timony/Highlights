...
class HighlightTest extends Specification {
    ...
    def 'should add segment - #desc'() {
        ...
        result.getSegments() == expectedSegments.collect { new HighlightSegment(elementId, it.key, it.value) }
        ...
        [0: 5, 10: 11]       | '01'      | 4     | 8   || [0: 4, 4: 8, 10: 11]  | 'new segment overlaps first existing'
        [0: 5, 10: 12]       | '01'      | 4     | 11  || [0: 4, 4: 11, 11: 12] | 'first segment overlaps both first and second existing'
        [0: 5, 10: 11]       | '01'      | 10    | 14  || [0: 5, 10: 14]        | 'second existing is eaten by new segment'
        [0: 5, 7: 8, 10: 14] | '01'      | 4     | 11  || [0: 4, 4: 11, 11: 14] | 'new segment eats second and shrinks first and third'
